        ...
        <div className="hidden border-r border-white/10 bg-[linear-gradient(180deg,rgba(99,179,237,0.08),rgba(167,139,250,0.03))] p-10 lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <p className="mt-5 max-w-md text-sm leading-7 text-slate-400">
              Log in to access your dashboard, saved roadmaps, resume insights,
              and personalized career tools.
            </p>
          </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-5">
            ...
            <p className="text-sm leading-6 text-slate-400">
              Track progress, analyze resumes, discover skill gaps, and build
              roadmaps with a consistent premium interface.
            </p>
          </div>
        </div>
        ...
        <div className="p-6 sm:p-8 md:p-10">
          <div className="mx-auto w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button className="inline-flex w-full items-center justify-center rounded-2xl border border-emerald-400/25 bg-gradient-to-r from-sky-400/20 to-violet-400/20 px-4 py-3 text-sm font-medium text-sky-200 transition hover:border-sky-300/50 hover:from-sky-400/30 hover:to-violet-400/30 hover:text-slate-50">
                Login
              </button>
            </form>
          </div>
